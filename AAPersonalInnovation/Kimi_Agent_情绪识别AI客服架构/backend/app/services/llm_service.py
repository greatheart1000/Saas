...
class LLMService:
    ...
    async def detect_sentiment(self, message: str, history: list[dict]) -> dict:
        """使用LLM检测情绪"""
...
- critical (0.7-1.0): 情绪严重不满，愤怒，需要立即处理"""
    ...
    async def detect_intent(self, message: str, history: list[dict]) -> dict:
        """使用LLM识别意图"""
...
"""
    ...
    async def generate_response(
        ...
        """基于RAG生成回复"""
        system_prompt = f"""你是一个专业的AI客服助手。你的职责是为用户提供友好、准确、富有同理心的回复。
